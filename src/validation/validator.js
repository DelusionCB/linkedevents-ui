...
const publicValidations = {
    ...
    audience_min_age: [VALIDATION_RULES.IS_INT, VALIDATION_RULES.REQUIRED_FOR_COURSES],
    audience_max_age: [VALIDATION_RULES.IS_INT],
    enrolment_start_time: [VALIDATION_RULES.IS_DATE, VALIDATION_RULES.REQUIRED_FOR_COURSES],
    enrolment_end_time: [VALIDATION_RULES.AFTER_ENROLMENT_START_TIME,
        VALIDATION_RULES.REQUIRED_FOR_COURSES,
        VALIDATION_RULES.IN_THE_FUTURE,
        VALIDATION_RULES.IS_DATE],
    enrolment_url: [VALIDATION_RULES.REQUIRED_FOR_COURSES, VALIDATION_RULES.IS_URL],
    minimum_attendee_capacity: [VALIDATION_RULES.IS_INT, VALIDATION_RULES.REQUIRED_FOR_COURSES],
    maximum_attendee_capacity: [VALIDATION_RULES.IS_INT, VALIDATION_RULES.REQUIRED_FOR_COURSES],
    videos: {
        url: [VALIDATION_RULES.IS_URL, VALIDATION_RULES.REQUIRED_VIDEO_FIELD],
        name: [VALIDATION_RULES.SHORT_STRING, VALIDATION_RULES.REQUIRED_VIDEO_FIELD],
        alt_text: [VALIDATION_RULES.MEDIUM_STRING, VALIDATION_RULES.REQUIRED_VIDEO_FIELD],

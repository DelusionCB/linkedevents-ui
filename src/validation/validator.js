...
const draftValidations = {
    ...
    minimum_attendee_capacity: [VALIDATION_RULES.IS_INT, VALIDATION_RULES.IS_POSITIVE_INT, VALIDATION_RULES.IS_LESS_THAN_MAX_CAPACITY, VALIDATION_RULES.MAXIMUM_CAPACITY],
    maximum_attendee_capacity: [VALIDATION_RULES.IS_INT, VALIDATION_RULES.IS_POSITIVE_INT, VALIDATION_RULES.IS_MORE_THAN_MIN_CAPACITY, VALIDATION_RULES.MAXIMUM_CAPACITY],
    videos: {

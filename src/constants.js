...
const constants = {
    ...
    FETCHING_ORGANIZATIONSDATA: 'FETCHING_ORGANIZATIONSDATA',
    RECEIVE_ORGANIZATIONSDATA: 'RECEIVE_ORGANIZATIONSDATA',
    RECEIVE_ORGANIZATIONS_ERROR: 'RECEIVE_ORGANIZATIONS_ERROR',

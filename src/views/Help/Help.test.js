...
import {UnconnectedHelp} from './index';
...
describe('Help', () => {
    function getWrapper(props) {
        return shallow(<UnconnectedHelp {...defaultProps} {...props} />, {context: {intl}});
    }
    ...
    describe('components', () => {
        ...
        describe('react-helmet', () => {
            ...
            test('react-helmet is defined and gets title prop', () => {
                ...
                const expectedValue = `Linkedevents - ${defaultProps.intl.formatMessage({id:'more-info'})}`;
